...
<html>
  ...
  <div class="row mt-5">
      ...
      <div class="col-sm-6 text-center bg-light border border-3 my-3 ps-5 pe-5">
          ...
          <h6>Study Center Login</h6>
          <form>
            <input type="text" name="name" placeholder="Enter Singin Id." class="form-control" required/><br/>
            ...
            <input type="submit" value="Sign Up" class="bg-primary text-light form-control"><br/>
              <center>Or <a href="universityadmin.jsp" style="color:blue;">Forgot Password.</a></center>
